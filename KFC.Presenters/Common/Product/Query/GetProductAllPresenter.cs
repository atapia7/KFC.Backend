...
public class GetProductAllPresenter : IGetProductAllOutputPort
{
    public bool IsSuccess { 
        get { return Messages is null; } 
    }  
    public QueryResult<IEnumerable<ProductDto>>? Data { get; set; }
    ...
    public Task HandleSuccess(IHandleSuccess<QueryResult<IEnumerable<ProductDto>>> success)
    {
        Data = success.Data;
