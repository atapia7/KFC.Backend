...
public class GetPriceChannelByCodePresenter : IGetPriceChannelByCodeOutputPort
{
    public bool IsSuccess { 
        get { return Messages is null; } 
    }  
    public PriceChannelDto? Data { get; set; }
    ...
    public Task HandleSuccess(IHandleSuccess<PriceChannelDto> success)
    {
        Data = success.Data;
