...
public class GetAccountSessionPresenter : IGetAccountSessionOutputPort
{
    public bool IsSuccess { 
        get { return Messages is null; } 
    }  
    public AccountSessionDto? Data { get; set; }
    ...
    public Task HandleSuccess(IHandleSuccess<AccountSessionDto> success)
    {
        Data = success.Data;
