...
public class DeletePriceChannelValidator: IInputPortValidator<DeletePriceChannelDto>
{
    private readonly IAccountRepository _accountRepository;
    private readonly IPriceChannelRepository _repository;


    public DeletePriceChannelValidator(IPriceChannelRepository repository, IAccountRepository accountRepository)
    {
    ...
    public async Task<bool> IsValid(DeletePriceChannelDto inputDto)
    {
        try
        {
