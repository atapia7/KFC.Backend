...
public class GetPriceChannelAllValidator : IInputPortValidator<GetPriceChannelAllDto>
{
	private readonly IAccountRepository _accountRepository;

	public GetPriceChannelAllValidator(IAccountRepository accountRepository)
	{
    ...
    public async Task<bool> IsValid(GetPriceChannelAllDto inputDto)
    {
        try
        {
