...
public class DeleteProductValidator: IInputPortValidator<DeleteProductDto>
{
    private readonly IAccountRepository _accountRepository;
    private readonly IProductRepository _repository;


    public DeleteProductValidator(IProductRepository repository, IAccountRepository accountRepository)
    {
    ...
    public async Task<bool> IsValid(DeleteProductDto inputDto)
    {
        try
        {
