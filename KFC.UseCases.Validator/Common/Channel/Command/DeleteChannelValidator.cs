...
public class DeleteChannelValidator: IInputPortValidator<DeleteChannelDto>
{
    private readonly IAccountRepository _accountRepository;
    private readonly IChannelRepository _repository;


    public DeleteChannelValidator(IChannelRepository repository, IAccountRepository accountRepository)
    {
    ...
    public async Task<bool> IsValid(DeleteChannelDto inputDto)
    {
        try
        {
