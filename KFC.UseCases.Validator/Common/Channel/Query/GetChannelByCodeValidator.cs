...
public class GetChannelByCodeValidator : IInputPortValidator<GetChannelByCodeDto>
{
	private readonly IAccountRepository _accountRepository;
	private readonly IChannelRepository _channelRepository;


	public GetChannelByCodeValidator(IAccountRepository accountRepository, IChannelRepository channelRepository)
	{
    ...
    public async Task<bool> IsValid(GetChannelByCodeDto inputDto)
    {
        try
        {
            ...
            var channel = await _channelRepository.GetChannelByCodeAsync(code: inputDto.ChannelCode);
            if ((channel is null)) 
            {
                HttpStatusCode = HttpStatusCode.NotFound;
                Messages = new List<MessageDto> { new MessageDto("channel no encontrado") };
                return false;
            }
