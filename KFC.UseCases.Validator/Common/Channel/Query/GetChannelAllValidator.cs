...
public class GetChannelAllValidator : IInputPortValidator<GetChannelAllDto>
{
	private readonly IAccountRepository _accountRepository;

	public GetChannelAllValidator(IAccountRepository accountRepository)
	{
    ...
    public async Task<bool> IsValid(GetChannelAllDto inputDto)
    {
        try
        {
