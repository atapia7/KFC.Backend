...
public class GetAccountByIdValidator : IInputPortValidator<GetAccountByIdDto>
{
	private readonly IAccountRepository _accountRepository;

	public GetAccountByIdValidator(IAccountRepository accountRepository)
	{
    ...
    public async Task<bool> IsValid(GetAccountByIdDto inputDto)
    {
        try
        {
