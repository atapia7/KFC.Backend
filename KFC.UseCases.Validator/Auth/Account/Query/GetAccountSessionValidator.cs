...
public class GetAccountSessionValidator : IInputPortValidator<GetSessionDto>
{
	private readonly IAccountRepository _accountRepository;

	public GetAccountSessionValidator(IAccountRepository accountRepository)
	{
    ...
    public async Task<bool> IsValid(GetSessionDto inputDto)
    {
        try
        {
